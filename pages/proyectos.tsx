...
function ProjectItem({project, setModalUpdateOpen, setModalDeleteOpen, setProject, callback } : 
	{project: Project, setModalUpdateOpen: Function, setModalDeleteOpen: Function, setProject: Function, callback: { function: Function} }) {
    return (
    ...
    return (
        <div style={{backgroundColor: "#DDDDDC", display: "flex", flexDirection: "column", height: "100%", padding: 90}}>
            ...
            {list.map((project, index) => (
                <ProjectItem project={project} setModalUpdateOpen={setModalUpdateOpen} setModalDeleteOpen={setModalDeleteOpen} 
				setProject={setProject} callback={callback} key={index}/>
            ))}
            <ModalCreate modalOpen={modalCreateOpen} setModalOpen={ModalCreateHandle}/>
            <ModalUpdate modalOpen={modalUpdateOpen} setModalOpen={ModalUpdateHandle} project={project} callback={callback}/>
